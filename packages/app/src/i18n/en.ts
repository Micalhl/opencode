export const dict = {
  ...
  "context.stats.group.sessionStats": "Session Statistics",
  "context.stats.group.tokenUsage": "Token Usage",
  "context.stats.modelTime": "Model Time",
  "context.stats.toolTime": "Tool Call Time",
  "context.stats.ttft": "Avg. First Token (TTFT)",
  "context.stats.tps": "Output Speed (TPS)",
  "context.stats.sessionTotal": "Total",
  "context.stats.cacheHit": "Cache Hit",
  "context.stats.uncachedInput": "Uncached Input",
  "context.stats.cacheRead": "Cache Read",
  "context.stats.output": "Output",
  "context.stats.duration.seconds": "{{seconds}}s",
  "context.stats.duration.minutes": "{{minutes}}m {{seconds}}s",
  "context.stats.duration.hours": "{{hours}}h {{minutes}}m",
  "context.stats.duration.ms": "{{ms}} ms",
  ...
  "goal.toast.createSuccess.description": "OpenCode will continue until the goal is complete, paused, or limited.",
  ...
  "settings.deploy.description": "The server-wide SSH identity managed by OpenCode.",
  "settings.deploy.publicKey.title": "SSH public key",
  "settings.deploy.publicKey.description":
    "Add this public key to a repository or host. OpenCode keeps the private key on this server and reuses it across restarts.",
