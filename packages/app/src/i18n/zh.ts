...
export const dict = {
  ...
  "context.stats.group.sessionStats": "会话统计",
  "context.stats.group.tokenUsage": "Token 用量",
  "context.stats.modelTime": "模型用时",
  "context.stats.toolTime": "工具调用用时",
  "context.stats.ttft": "首 token 平均（TTFT）",
  "context.stats.tps": "输出速度（TPS）",
  "context.stats.sessionTotal": "总计",
  "context.stats.cacheHit": "缓存命中",
  "context.stats.uncachedInput": "未缓存输入",
  "context.stats.cacheRead": "缓存读取",
  "context.stats.output": "输出",
  "context.stats.duration.seconds": "{{seconds}}秒",
  "context.stats.duration.minutes": "{{minutes}}分 {{seconds}}秒",
  "context.stats.duration.hours": "{{hours}}时 {{minutes}}分",
  ...
  "goal.toast.createSuccess.description": "OpenCode 将持续执行，直到目标完成、暂停或达到限制。",
  ...
  "settings.deploy.description": "由 OpenCode 管理的服务器级 SSH 身份。",
