...
export const dict = {
  ...
  "provider.connect.apiKey.description": "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 OpenCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 並輸入以下程式碼，以連線你的帳戶並在 OpenCode 中使用 {{provider}} 模型。",
  ...
  "context.stats.group.sessionStats": "工作階段統計",
  "context.stats.group.tokenUsage": "Token 用量",
  "context.stats.modelTime": "模型用時",
  "context.stats.toolTime": "工具呼叫用時",
  "context.stats.ttft": "首 token 平均（TTFT）",
  "context.stats.tps": "輸出速度（TPS）",
  "context.stats.sessionTotal": "總計",
  "context.stats.cacheHit": "快取命中",
  "context.stats.uncachedInput": "未快取輸入",
  "context.stats.cacheRead": "快取讀取",
  "context.stats.output": "輸出",
  "context.stats.duration.seconds": "{{seconds}}秒",
  "context.stats.duration.minutes": "{{minutes}}分 {{seconds}}秒",
  "context.stats.duration.hours": "{{hours}}時 {{minutes}}分",
  "context.stats.duration.ms": "{{ms}} 毫秒",
  ...
  "goal.toast.createSuccess.description": "OpenCode 將持續執行，直到目標完成、暫停或達到限制。",
  ...
  "settings.deploy.description": "由 OpenCode 管理的伺服器級 SSH 身分。",
